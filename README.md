...
```
### نصائح
* لازم تكون ذو همة وعزيمة &larr; أخي لن تنال العلم إلا بستة سأنبيك عن تفصيلها ببيان ذكاء وحرص واجتهاد وبلغة وصحبة أستاذ وطول زمان.
* دا أول وأهم مشروع هتشتغل عليه في الكلية.
* أتعلم الجيتهاب.
* وأنت بتختار فريق العمل لازم تختار اللي بتعرف تتعامل معاهم، وأختيارك لفريق بتعرف تتعامل معاه أفضل من أختيارك لفريق شاطر ومبتعرفش تتعامل معاه، وأفتكر إنكم هتقضوا سنة كاملة مع بعض.
* طور مهاراتك في البحث والإعتماد على نفسك.
* طور مهارات التواصل والشرح والعرض عندك.
* متخافش :)
* دي الريبو بتاعت مشروعنا ممكن تشوفها وتشوف الدوكس بتتعمل ازاي     https://github.com/SssiiiSssiii/Graduation-Project
